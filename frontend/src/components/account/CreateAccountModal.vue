    ...
    >
      ...
      <div v-if="form.platform === 'gemini'">
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            class="flex items-center gap-1 rounded px-2 py-1 text-xs text-cyan-600 hover:bg-cyan-50 dark:text-cyan-400 dark:hover:bg-cyan-900/20"
          >
        ...
        >
          ...
          <div class="mt-2 flex flex-wrap gap-2">
            <a
              ...
              class="font-medium text-cyan-600 hover:underline dark:text-cyan-400"
              target="_blank"
              rel="noreferrer"
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <a
                    ...
                    class="ml-1 text-cyan-600 hover:underline dark:text-cyan-400"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-cyan-100 px-2 py-0.5 text-[10px] font-semibold text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300"
                  >
                    企业用户
                  </span>
                  <span
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
          ...
          <div v-if="poolModeEnabled" class="rounded-lg bg-cyan-50 p-3 dark:bg-cyan-900/20">
