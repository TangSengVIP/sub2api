<template>
  <div>
    ...
    <button
      ...
      :class="{ 'text-cyan-600 dark:text-cyan-400': unreadCount > 0 }"
      ...
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            ...
            <div class="relative overflow-hidden border-b border-gray-100/80 bg-gradient-to-br from-cyan-50/50 to-indigo-50/30 px-6 py-5 dark:border-dark-700/50 dark:from-cyan-900/10 dark:to-indigo-900/5">
              <div class="relative z-10 flex items-start justify-between">
                <div>
                  <div class="flex items-center gap-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-indigo-600 text-white shadow-lg shadow-cyan-500/30">
                  ...
                  <p v-if="unreadCount > 0" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    <span class="font-medium text-cyan-600 dark:text-cyan-400">{{ unreadCount }}</span>
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    @click="markAllAsRead"
                    :disabled="loading"
                    class="rounded-lg bg-cyan-600 px-4 py-2 text-xs font-medium text-white shadow-lg shadow-cyan-500/30 transition-all hover:bg-cyan-700 hover:shadow-xl disabled:opacity-50 dark:bg-cyan-500 dark:hover:bg-cyan-600"
                  >
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-if="loading" class="flex items-center justify-center py-16">
                <div class="relative">
                  ...
                  <div class="absolute inset-0 h-12 w-12 animate-pulse rounded-full border-4 border-cyan-400/30"></div>
                </div>
              </div>
              ...
              <div v-else-if="announcements.length > 0">
                <div
                  ...
                  :class="{ 'bg-cyan-50/30 dark:bg-cyan-900/5': !item.read_at }"
                ...
                >
                  ...
                  <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center">
                    <div
                      v-if="!item.read_at"
                      class="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-indigo-600 text-white shadow-lg shadow-cyan-500/30"
                    >
                      <!-- Pulse ring -->
                      <span class="absolute inline-flex h-full w-full animate-ping rounded-xl bg-cyan-400 opacity-75"></span>
                      <!-- Icon -->
                      ...
                      <div class="mt-1 flex items-center gap-2">
                        ...
                        >
                          <span class="relative flex h-1.5 w-1.5">
                            ...
                            <span class="relative inline-flex h-1.5 w-1.5 rounded-full bg-cyan-600"></span>
                          </span>
                          {{ t('announcements.unread') }}
                        </span>
                      </div>
                  ...
                  <div
                    v-if="!item.read_at"
                    class="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-cyan-500 to-indigo-600"
                  ></div>
                </div>
              </div>
      ...
      <Transition name="modal-fade">
        ...
        >
          ...
          >
            ...
            <div class="relative overflow-hidden border-b border-gray-100 bg-gradient-to-br from-cyan-50/80 via-indigo-50/50 to-purple-50/30 px-8 py-6 dark:border-dark-700 dark:from-cyan-900/20 dark:via-indigo-900/10 dark:to-purple-900/5">
              ...
              <div class="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-gradient-to-br from-cyan-400/20 to-indigo-500/20 blur-3xl"></div>
              ...
              <div class="relative z-10 flex items-start justify-between gap-4">
                <div class="flex-1 min-w-0">
                  ...
                  <div class="mb-3 flex items-center gap-2">
                    <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-indigo-600 text-white shadow-lg shadow-cyan-500/30">
                      <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div class="flex items-center gap-2">
                      ...
                      <span
                        ...
                        class="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-cyan-500 to-indigo-600 px-2.5 py-1 text-xs font-medium text-white shadow-lg shadow-cyan-500/30"
                      >
            ...
            <div class="max-h-[60vh] overflow-y-auto bg-white px-8 py-8 dark:bg-dark-800">
              ...
              <div class="relative">
                ...
                <div class="absolute left-0 top-0 bottom-0 w-1 rounded-full bg-gradient-to-b from-cyan-500 via-indigo-500 to-purple-500"></div>
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    ...
                    class="rounded-xl bg-gradient-to-r from-cyan-600 to-indigo-600 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-cyan-500/30 transition-all hover:shadow-xl hover:scale-105"
                  >
...
.markdown-body a {
  @apply font-medium text-cyan-600 underline decoration-blue-600/30 decoration-2 underline-offset-2 transition-all hover:decoration-blue-600 dark:text-cyan-400 dark:decoration-blue-400/30 dark:hover:decoration-blue-400;
}
...
.markdown-body blockquote {
  @apply relative my-5 border-l-4 border-cyan-500 bg-cyan-50/50 py-3 pl-5 pr-4 italic text-gray-700 dark:border-cyan-400 dark:bg-cyan-900/10 dark:text-gray-300;
}

.markdown-body blockquote::before {
  content: '"';
  @apply absolute -left-1 top-0 text-5xl font-serif text-cyan-500/20 dark:text-cyan-400/20;
}
...
.markdown-body th {
  @apply bg-gradient-to-br from-cyan-50 to-indigo-50 font-semibold text-gray-900 dark:from-cyan-900/20 dark:to-indigo-900/10 dark:text-white;
}
